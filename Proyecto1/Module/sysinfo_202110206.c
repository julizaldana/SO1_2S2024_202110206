...
MODULE_DESCRIPTION("Modulo para leer informacion de memoria y recursos consumidos por contenedores docker en JSON");
MODULE_VERSION("1.0");

#define PROC_NAME "sysinfo_202110206"
...
static int sysinfo_show(struct seq_file *m, void *v) {
    ...
    */
    ...
    seq_printf(m, "{\n");
    seq_printf(m, "  \"RAMmemory\": [\n");
    seq_printf(m, "    {\n");
    seq_printf(m, "      \"TotalRAM\": \"%lu MB\",\n", totalram_mb);
    seq_printf(m, "      \"FreeRAM\": \"%lu MB\",\n", freeram_mb);
    seq_printf(m, "      \"UsedRAM\": \"%lu MB\"\n", usedram_mb);
    seq_printf(m, "    }\n");
    seq_printf(m, "  ],\n");
